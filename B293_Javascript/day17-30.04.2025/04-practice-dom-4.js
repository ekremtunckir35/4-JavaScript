import { students } from "../day16-29.04.2025/data/students.js";
...
//   console.log(tBodyInside);
  ...
  let pointElements = document.querySelectorAll("table tbody tr td:nth-child(3)");
...
document.querySelector("table tbody").addEventListener("click", (e) => {
    ...
    if(e.target.innerText === "Sil"){
        ...
        let result = confirm(`${name} isimli kaydı silmek istediğinize emin misiniz?`);
